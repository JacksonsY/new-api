...
func TestUsageAccountingSupportsSignedDirectAndBatchDeltas(t *testing.T) {
	...
	UpdateChannelUsedQuota(channel.Id, -200, 1.0)
	UpdateChannelUsedQuota(channel.Id, 50, 1.0)
	...
	UpdateChannelUsedQuota(channel.Id, 400, 1.0)
	UpdateChannelUsedQuota(channel.Id, -100, 1.0)
