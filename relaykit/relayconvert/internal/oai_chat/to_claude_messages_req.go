...
func OpenAIChatRequestToClaudeMessages(c context.Context, info convmeta.Meta, textRequest dto.GeneralOpenAIRequest) (*dto.ClaudeRequest, error) {
	...
	if textRequest.WebSearchOptions != nil {
		...
		case "low":
			webSearchTool.MaxUses = kitutil.GetPointer(webSearchMaxUsesLow)
		case "medium":
			webSearchTool.MaxUses = kitutil.GetPointer(webSearchMaxUsesMedium)
		case "high":
			webSearchTool.MaxUses = kitutil.GetPointer(webSearchMaxUsesHigh)
		}
