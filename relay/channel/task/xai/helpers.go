...
// Duration is a billing multiplier, so every path is capped at
// MaxTaskDurationSeconds; the float case is compared before the int
// conversion because converting an out-of-range float64 is undefined.
