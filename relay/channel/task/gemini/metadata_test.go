...
func TestApplyVeoMetadataToInstanceSupportsFramesAndReferenceImages(t *testing.T) {
	...
	// Metadata may be written in the generateContent-style inlineData shape,
	// but predictLongRunning only accepts bytesBase64Encoded/mimeType. Pin the
	// upstream wire format so the two never get conflated again.
