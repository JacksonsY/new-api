    ...
    build: (settings: BillingSettings) => (
      <PaymentSettingsSection
        defaultValues={{
          ...
          EpayApiVersion: settings.EpayApiVersion === 'v2' ? 'v2' : 'v1',
          EpayPlatformPublicKey: settings.EpayPlatformPublicKey,
          EpayMerchantPrivateKey: settings.EpayMerchantPrivateKey,
